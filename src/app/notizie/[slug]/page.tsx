  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <article className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-10">
        {p.body ? <Markdown>{p.body}</Markdown> : <p className="text-slate-700">{p.excerpt}</p>}

        {/* Share con loghi ufficiali (inline SVG Bootstrap Icons) */}
        <div className="mt-12">
        ...
        {/* Torna alle notizie (in basso a sinistra) */}
        <div className="mt-12">
