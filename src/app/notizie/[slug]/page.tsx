...
export default async function PostPage({
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      {/* HERO — stessa impostazione degli eventi */}
      <header className="relative">
        {/* immagine di sfondo con altezza responsiva */}
        <div className="relative h-[clamp(16rem,45vh,42rem)] md:h-[clamp(24rem,50vh,48rem)] w-full overflow-hidden">
          <Image
            src={p.image} // path locale in /public, es. "/images/news/cover.jpg"
            alt={p.title}
            fill
            priority
            sizes="100vw"
        ...
        {/* overlay separato come negli eventi */}
