export type Post = {
  ...
  date: string; // ISO
  read: string;
  category: "Comunicati" | "Territorio" | "Iniziative" | "Trasparenza" | "Eventi" | "Partecipazione";
  image: string;
  slug: string;
  body?: string;
};
...
export const POSTS: Post[] = [
  {
    ...
    image: "https://images.unsplash.com/photo-1599050751793-23b03b3c6b4d?q=80&w=1600&auto=format&fit=crop",
...
export const EVENTS: EventItem[] = [
  {
    ...
    category: "Assemblea",
    district: "Centro",
    cover: "https://images.unsplash.com/photo-1459499362902-55a20553e082?q=80&w=1600&auto=format&fit=crop",
...
`.trim(),
  ...
  category: "Incontro",
  district: "Centro",
  cover: "https://images.unsplash.com/photo-1535448583043-6f3517d9f52b?q=80&w=1600&auto=format&fit=crop",
...
},
{
  ...
  district: "Est",
  cover: "https://images.unsplash.com/photo-1482192596544-9eb780fc7f66?q=80&w=1600&auto=format&fit=crop",
...
},
{
  ...
  district: "Nord",
  cover: "https://images.unsplash.com/photo-1523580846011-d3a5bc25702b?q=80&w=1600&auto=format&fit=crop",
...
},
{
  ...
  category: "Assemblea",
  district: "Sud",
  cover: "https://images.unsplash.com/photo-1464863979621-258859e62245?q=80&w=1600&auto=format&fit=crop",
...
},
{
  ...
  description: "Conosci i gruppi di lavoro, i progetti e come partecipare attivamente.",
  rsvpUrl: "#",
  body: `
...
},
{
  ...
  description: "Hack-lab cittadino per rigenerare edifici dismessi con usi temporanei.",
  rsvpUrl: "#",
  body: `
...
},
{
  ...
  cover: "https://images.unsplash.com/photo-1554469384-e58fac16e23a?q=80&w=1600&auto=format&fit=crop",
  description: "Gazebo in tutti i quartieri con materiali informativi e raccolta adesioni.",
  rsvpUrl: "#",
  body: `
